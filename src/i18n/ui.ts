...
export const ui = {
  en: {
    ...
    'books.title': 'Books',
    'books.subtitle': 'Cover gallery — fifty volumes in print.',
    'books.note': 'Titles, publication years and purchase links will be added as the full metadata is prepared. The image order follows the original inventory numbering.',
    'books.count': 'volumes',
  ...
  bn: {
    ...
    'books.title': 'বইসমূহ',
    'books.subtitle': 'প্রচ্ছদ সংগ্রহ — মুদ্রিত পঞ্চাশটি গ্রন্থ।',
    'books.note': 'প্রতিটি বইয়ের শিরোনাম, প্রকাশকাল ও সংগ্রহের লিংক পূর্ণ তথ্য প্রস্তুত হলে সংযোজিত হবে। ছবির ক্রম মূল তালিকা অনুসারে।',
    'books.count': 'বই',
